...
map.getView().fit([2324327.107901, 6867628.802110, 2437113.653646, 6935974.073708], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Analiza rzeki BUG 1940-2025</h2>';
        return titleElement;
    })(),
